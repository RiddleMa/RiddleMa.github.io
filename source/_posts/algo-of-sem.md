...
##### 光学干涉检测(Optical Interference Inspection)
...
![Fig.4.1.1 An example of shifts in measurement values](13.jpg)
...
![Fig.4.1.2 Gaussian (normal) distribution](14.jpg)

图 4.1.3（a）中σ较小，表示变异较小；图4-3（b）中σ较大，表示变异较大。变异较小时，精度（或重复性）较高（良好）。

![Fig.4.1.3 Gaussian(normal) distribution (Part 2)](15.jpg)
...
![Fig.4.1.4 Gaussian (normal) distribution (Part 3)](16.jpg)
...
![Fig.4.1.5 Precision and accuracy](17.jpg)
...
![Fig.4.2.1 Measuring a fine pattern on a wafer](18.png)
...
![Fig.4.2.2 Photoresist line (SEM image) and line profile](19.png)

也就是说，图 4.2.2 中的图像给出了线轮廓，而轮廓又给出了线宽。如果线横截面呈梯形，如图 4.2.4 所示，则顶部和底部的宽度将不同。在这种情况下，测量位置将在配方中指定。此外，还可以指定所需的高度位置。

**SEM image**
![Fig.4.2.3 Relationship between the SEM image ofline & space and the schematic cross-sectional view and the line profile](20.png)

**Line profile**
![Fig.4.2.4 Relationship between the line schematiccross-sectional view and the line profile](21.png)
...
![Fig.4.3.1 Principles of defect detection on a patterned wafer](23.png)
...
![Fig.4.3.2 Principle of defect detection on a non-patterned wafer(1)](24.png)
...
![Fig.4.3.3 Principle of defect detection on a non-patterned wafer(2)](25.png)
...
![Fig.4.3.4 An example of detecting the residue at thebottom of a contact hole.](26.png)
